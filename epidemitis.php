...
<div class="col-md-10 mt-5">
  ...
  <br>
  <img src="https://www.alomedika.com/wp-content/uploads/2019/04/Depositphotos_219100100_s-2019.jpg"
   class="rounded mx-auto d-block" alt="Hasil Detection">
   <p>
   <h2 style="text-align: center;">Anda Terdekteksi Penyakit EPIDEMITIS</h2>
   <br>
   <h2 style="text-align: center;">SOLUSI</h2>
   <h4 style="text-align: center;">Penanganan epididimitis bertujuan untuk mengatasi infeksi dan meredakan gejala yang timbul. Salah satunya adalah dengan pemberian obat, seperti:
...
Obat pereda nyeri. Untuk meredakan rasa sakit yang timbul akibat epididimitis, dokter akan meresepkan obat pereda nyeri. Contohnya adalah paracetamol atau ibuprofen.</h4>
   </p>
