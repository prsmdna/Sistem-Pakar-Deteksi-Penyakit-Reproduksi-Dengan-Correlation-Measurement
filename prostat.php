...
<div class="col-md-10 mt-5">
  ...
  <br>
  <img src="https://image-cdn.medkomtek.com/s1qFxFwawVZuvUuy57t2eWQxWww=/673x373/smart/filters:quality(75):strip_icc():format(jpeg)/klikdokter-media-buckets/medias/2278497/original/068069000_1531449274-BPH-Benign-Prostatic-Hyperplasia-By-Designua-shutterstock.jpg"
   class="rounded mx-auto d-block" alt="Hasil Detection">
   <p>
   <h2 style="text-align: center;">Anda Terdekteksi Penyakit PROSTAT</h2>
   <br>
   <h2 style="text-align: center;">SOLUSI</h2>
   <h4 style="text-align: center;">Bentuk paling umum dari perawatan medis guna mengobati masalah prostat melibatkan obat antibiotik, 
   alpha blockers, dan 5-alpha reductase inhibitors.</h4>
   </p>
