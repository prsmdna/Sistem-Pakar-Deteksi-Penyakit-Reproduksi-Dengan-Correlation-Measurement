...
<html lang="en">
  ...
  <li class="nav-item mb-1">
    <a class="nav-link text-light" href="hasil.php">Hasil Diagnosa</a><hr class="bg-white">
  </li>
</ul>
    </div>
...
<div class="col-md-10 mt-5">
  ...
  <br>
  <img src="http://3.bp.blogspot.com/-ptS_j-xxbbM/VoKfKFP6WkI/AAAAAAAAABU/MYbI1ApMDPY/w1200-h630-p-k-no-nu/ht_testosterone_primary_hypogonadism_0804.jpg"
   class="rounded mx-auto d-block" alt="Hasil Detection">
   <p>
   <h2 style="text-align: center;">Anda Terdekteksi Penyakit HIPOGONADISME</h2>
   <br>
   <h2 style="text-align: center;">SOLUSI</h2>
   <h4 style="text-align: center;">Pada pria digunakan hormon testosteron dengan suntikan, koyo, gel, atau pil yang bukan ditelan tetapi diletakkan di bawah lidah.
Pada wanita digunakan kombinasi hormon estrogen dan progesteron, karena hormon estrogen jika digunakan tunggal dapat meningkatkan risiko kanker endometrium.</h4>
   </p>
