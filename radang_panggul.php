...
<div class="col-md-10 mt-5">
  ...
  <br>
  <img src="https://pingpoint.co.id/media/images/Yuk_Kenali_Penyakit_Radang_Panggul_FILEminimize.original.jpg"
   class="rounded mx-auto d-block" alt="Hasil Detection">
   <p>
   <h2 style="text-align: center;">Anda Terdekteksi Penyakit RADANG PANGGUL</h2>
   <br>
   <h2 style="text-align: center;">SOLUSI</h2>
   <h4 style="text-align: center;">Untuk mengatasi radang panggul, pemberian obat akan disesuaikan dengan kondisi pasien. 
   Jika disebabkan oleh infeksi bakteri, dokter akan memberikan antibiotik. Selain antibiotik, dokter akan memberikan obat untuk mengurangi keluhan, seperti nyeri dan demam, 
   Beberapa obat yang bisa diberikan adalah ibuprofen dan paracetamol.</h4>
   </p>
