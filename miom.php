...
<div class="col-md-10 mt-5">
  ...
  <br>
  <img src="https://cdn-brilio-net.akamaized.net/community/2019/02/07/16929/image_1549507125_5c5b9a3502242.jpg"
   class="rounded mx-auto d-block" alt="Hasil Detection">
   <p>
   <h2 style="text-align: center;">Anda Terdekteksi Penyakit MIOM</h2>
   <br>
   <h2 style="text-align: center;">SOLUSI</h2>
   <h4 style="text-align: center;">Jika gejala yang muncul akibat miom cukup parah dan pengobatan yang dilakukan tidak berhasil, 
   penderita akan disarankan menjalani operasi pengangkatan rahim, miom, imbolisasi arteri rahim atau ablasi endometrium.</h4>
   </p>
