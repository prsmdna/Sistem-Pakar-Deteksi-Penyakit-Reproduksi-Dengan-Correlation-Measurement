...
<div class="col-md-10 mt-5">
  ...
  <br>
  <img src="https://dokter.my/images/obgyn/pcos-1.jpg"
   class="rounded mx-auto d-block" alt="Hasil Detection">
   <p>
   <h2 style="text-align: center;">Anda Terdekteksi Penyakit Polycystic Ovarian Syndrome (PCOS)</h2>
   <br>
   <h2 style="text-align: center;">SOLUSI</h2>
   <h4 style="text-align: center;">Direkomendasikan konsumsi hormon progesteron saja selama 10-14 hari selama 1-2 bulan. 
   Penggunaan hormon ini dapat mengatur siklus haid yang terganggu.</h4>
   </p>
